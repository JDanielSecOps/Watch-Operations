...
import { ModeToggle } from "../Theme-Switcher/theme-switcher";
...
const Navbar =()=>{
    ...
    const path =[
        ...
        {href:"/Alerts",label:"Alerts",svg:(
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"  ><path d="m344-60-76-128-144-32 14-148-98-112 98-112-14-148 144-32 76-128 136 58 136-58 76 128 144 32-14 148 98 112-98 112 14 148-144 32-76 128-136-58-136 58Zm34-102 102-44 104 44 56-96 110-26-10-112 74-84-74-86 10-112-110-24-58-96-102 44-104-44-56 96-110 24 10 112-74 86 74 84-10 114 110 24 58 96Zm102-318Zm0 200q17 0 28.5-11.5T520-320q0-17-11.5-28.5T480-360q-17 0-28.5 11.5T440-320q0 17 11.5 28.5T480-280Zm-40-160h80v-240h-80v240Z"/></svg>
        )},
    ...
    return(
        <div className={navbarstyles.navbar}>
            ...
            <svg className={navbarstyles.NavSvg} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" ><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg></button> 
            </div>    
            ...
            <svg className={navbarstyles.CloseSvg} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" ><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></button>
 
                {render(path)}
                <SignoutButton className={navbarstyles.signout}/>
            <div className={navbarstyles.toggle}>
                <ModeToggle/>
            </div>
